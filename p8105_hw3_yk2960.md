...
=======
eval\_set is which evaluation set this order belongs in and only have
one value “train”. ordered has two possible values, 1 if this product
has been ordered by this user in the past,0 otherwise</br> order\_number
is the order sequence number for this user (1=first, n=nth)</br> Here is
one example for the dataset and shows the type for each variable
>>>>>>> d48de6fca2e7ce225f72cf5b398fed9a31006fe9
...
items.*
=======
I group this dataset by aisle and arrange it by the amount of items.
>>>>>>> d48de6fca2e7ce225f72cf5b398fed9a31006fe9
...
point chart)*
=======
first find the aisles whose number of items is more than 10000, then
show the reasonable plot.(bar chart is more readable than point chart)
>>>>>>> d48de6fca2e7ce225f72cf5b398fed9a31006fe9
...
=======
\#\#\# Top 3 (Q1.3) find the three key aisles from the dataset
>>>>>>> d48de6fca2e7ce225f72cf5b398fed9a31006fe9
...
=======
group the newdataset first and then count the items and rank them,
...
weekday.*
=======
Use pivot wider to change the table from 3x7 to 7x3(I think it is more
readable), I also change the order\_dow number to actual weekday.
>>>>>>> d48de6fca2e7ce225f72cf5b398fed9a31006fe9
...
\#\#\#Clean Data (Q2.0) I clean the names, focus on Overall Health,
taking levels ordered from “Poor” to “Excellent”(1 to 5).
>>>>>>> d48de6fca2e7ce225f72cf5b398fed9a31006fe9
...
data2002<-brfss %>% 
=======
First I choose the specific year and variables state and detailed
address, and then I use unique() method to make sure each location only
occur once. Then I use group by method to fix it. Here is the table for
year 2002 and 2010.
...
=======
<img src="p8105_hw3_yk2960_files/figure-gfm/unnamed-chunk-10-1.png" width="90%" />
>>>>>>> d48de6fca2e7ce225f72cf5b398fed9a31006fe9
...
=======
<img src="p8105_hw3_yk2960_files/figure-gfm/unnamed-chunk-14-1.png" width="90%" />
>>>>>>> d48de6fca2e7ce225f72cf5b398fed9a31006fe9
